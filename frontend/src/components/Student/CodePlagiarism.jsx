...
const CodePlagiarism = () => {
  ...
  const runCheck = async () => {
    ...
    const endpoint =
      '${import.meta.env.VITE_API_URL}/api/plagiarism/code-similarity';
    ...
    <div className="tool-container">
      ...
      <div className="check-card">
          ...
          <div style={{ pointerEvents: 'none' }}>
            ...
            <div className="upload-text">
              {file ? (
                ...
                <span>
                  Click or Drag to Upload Code File (Python, Java, JS, C++)
                </span>
              )}
            </div>
          </div>
        ...
        {error && (
          <div
            className="error-msg"
            style={{ color: '#ff4757', marginTop: '15px', textAlign: 'center' }}
          >
            {error}
          </div>
        )}
      ...
      {result && (
        <div
          className={`result-section ${result.similarity > 30 ? 'ai-detected' : 'human-detected'}`}
        ...
        >
          ...
          >
            ...
            >
              ...
              <p style={{ margin: 0, fontWeight: '600', color: '#0ea5e9' }}>
                {result.lexical_similarity || 0}%
              </p>
            </div>
            <div
              className="detail-card"
            ...
            >
              ...
              <p style={{ margin: 0, fontWeight: '600', color: '#8b5cf6' }}>
                {result.structural_similarity || 0}%
              </p>
            </div>
          </div>
        </div>
