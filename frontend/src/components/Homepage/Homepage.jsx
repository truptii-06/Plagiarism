              ...
              <div className="right-content">
                <div className="login-card">
                  <div className="login-logo">
                    <img src={logoText} alt="SmartPlag Logo" />
                  </div>
      ...
      <section className="our-services" id="services">
        ...
        <div className="service-cards">
          ...
          <div className="service-card">
            ...
            <p>
              SmartPlag works across multiple languages, removing barriers in
              plagiarism checking.
            </p>
          </div>
          ...
          <div className="service-card">
            ...
            <p>
              Get scores, highlighted matches, and insights to improve writing
              integrity.
            </p>
          </div>
        </div>
      ...
      <section className="why-choose-us" id="about">
        ...
        <div className="card">
          <div className="card-text">
            ...
            <p>
              SmartPlag identifies AI-generated content to maintain academic
              integrity.
            </p>
          </div>
      ...
      <footer className="site-footer">
        <div className="footer-container">
          ...
          <div className="footer-contact">
            <h4>Contact</h4>
            <p>Email: support@smartplag.com</p>
        ...
        <div className="footer-bottom">
          <p>© 2025 SmartPlag. All rights reserved.</p>
        </div>
      </footer>
    </>
  );
