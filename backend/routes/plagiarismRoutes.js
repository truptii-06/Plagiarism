...
const { runPlagiarism, runAICodeCheck, runTextCheck, runCodeSimilarity, generateReport, runCEICheck, compareCodeSubmission } = require("../controllers/plagiarismController");
...
router.post("/compare-code", compareCodeSubmission);
